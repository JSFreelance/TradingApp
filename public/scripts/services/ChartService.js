angular.module('TradeApp').service('ChartService', ['$http', 'config', function($http, config) {
    return {
    lineChart: {
    ...
    //Data is represented as an array of {x,y} pairs.
        ...
        var money_history = [1355.89, 1322.89, 2255.89,
            9565.35, 2736.24, 1652.06, 3335.55, 5555.02, 1003.21, 8725.21];

        for (var i = 0; i < 10; i++) {
            sin.push({x: i, y: money_history[i]});
    ...
    return [
        {
            ...
            key: 'Sell amount (USD)', //key  - the name of the series.
